    ...
    return (
        <div className='w-full bg-white rounded'>
            ...
            <main className='flex flex-col'>
                ...
                <img className='min-w-86 h-80 object-cover lg:object-fill' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQVv0X1OiwK4BXsh6RT2w1jXWPS3LoHJ74_Q&s" alt="" />
