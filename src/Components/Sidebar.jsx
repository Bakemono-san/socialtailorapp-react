...
export default function Sidebar(props) {
  return (
    <div className={props.color+ ` md:py-8 md:px-4 flex md:flex-col md:gap-10 md:h-full text-white md:rounded w-full min-h-12 border-t border-gray-300 shadow md:w-fit`}>
